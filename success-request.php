    ...
    <section class="section title success">
      <div class="panel center-panel">
        ...
        <div class="button-area">
          <a href="requests.php"><button class="button-default">Make Another Requests</button></a>
          <?php if (!$isAdmin) : ?>
            <a href="user-requests.php"><button class="button-alt">View Requests</button></a>
          <?php else : ?>
            <a href="admin-requests.php"><button class="button-alt">View Requests</button></a>
          <?php endif; ?>
        </div>
      </div>
    </section>
