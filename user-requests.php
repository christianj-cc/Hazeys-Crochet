                ...
                <?php foreach ($requests as $request): ?>
                  <tr class="table-row">
                    ...
                    <?php if ($request['RequestStatus'] == "Pending"): ?>
                      <td>N/A</td>
                    <?php else: ?>
                      <td>₱<?= number_format($request['RequestPrice'], 2) ?></td>
                    <?php endif; ?>
                    ...
                    <td>
                      <?php if ($request['RequestStatus'] == "To Pay"): ?>
                        <div class="button-area">
                          <a href="user-payment.php?request_id=<?= urlencode($request['RequestId']) ?>">
                            <button type="submit" class="table-button btn-update">
                              <i class="fa fa-money"></i> Pay Amount
                            </button>
                          </a>
                        </div>
                      ...
                      <div class="dropdown-items">
                        <table>
                          ...
                          <tr class="dropdown-items-data">
                            <td style="width: 10%;"><?= htmlspecialchars($request['Deadline']) ?></td>
                            <td style="width: 30%;"><?= htmlspecialchars($request['Instructions']) ?></td>
                            <td style="width: 30%;"><?= htmlspecialchars($request['AdminMessage']) ?></td>
                          </tr>
                        </table>
                      </div>
                    </td>
