...
$requests = fetchRequests('Delivered');
      ...
      <div class="user-info-main">
        ...
        <div class="user-main-area">
          <div class="StatusTabs">
            ...
            <a href="admin-requests-Delivered.php"><button class="button-alt active">Delivered</button></a>
          ...
          <div class="table-list user-list">
            <table>
              <?php if (!empty($requests)): ?>
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <p style="text-align: center; font-weight:600; font-size:20px;">No delivered requests found.</p>
              <?php endif; ?>
            </table>
            <br>
          </div>
