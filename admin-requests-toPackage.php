...
$requests = fetchRequests('To Package');
      ...
      <div class="user-info-main">
        ...
        <div class="user-main-area">
          <div class="StatusTabs">
            ...
            <a href="admin-requests-toPackage.php"><button class="button-alt active">To Package</button></a>
            ...
            <a href="admin-requests-Rejected.php"><button class="button-alt">Rejected</button></a>
          </div>
        </div>
        <div class="user-main-area">
              ...
              <?php if (!empty($requests)): ?>
                ...
                <?php foreach ($requests as $request): ?>
                  <tr>
                    ...
                    <td>
                      <?= htmlspecialchars($request['PaymentMethod']) ?>
                      <?php if (!empty($request['ReceiptImage'])): ?>
                        <a href="<?= htmlspecialchars($request['ReceiptImage']) ?>" target="_blank">
                          <button class="table-button">
                            <i class="fa fa-image"></i>&nbspView
                          </button>
                        </a>
                    ...
                    <td>
                      <div class="button-area">
                        <form action="actions/db_updateRequestStatus.php" method="POST">
                          ...
                          <button type="button" class="table-button btn-update confirmTrigger" data-message="Are you sure you want to update the status of this request?">
                            <i class="fa fa-check"></i> Packaged
                          </button>
                        </form>
                      </div>
                    </td>
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <p style="text-align: center; font-weight:600; font-size:20px;">No requests to be packaged.</p>
              <?php endif; ?>
            </table>
            <br>
          </div>
