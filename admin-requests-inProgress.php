...
$requests = fetchRequests('In Progress');
      ...
      <div class="user-info-main">
        ...
        <div class="user-main-area">
          <div class="StatusTabs">
            ...
            <a href="admin-requests-inProgress.php"><button class="button-alt active">In Progress</button></a>
          ...
          <div class="table-list user-list">
            <table>
              <?php if (!empty($requests)): ?>
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <p style="text-align: center; font-weight:600; font-size:20px;">No requests to work on.</p>
              <?php endif; ?>
            </table>
            <br>
          </div>
