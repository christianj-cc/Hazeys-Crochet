...
$requests = fetchRequests('Completed');
      ...
      <div class="user-info-main">
        ...
        <div class="user-main-area">
          <div class="StatusTabs">
            ...
            <a href="admin-requests-Completed.php"><button class="button-alt active">Completed</button></a>
          ...
          <div class="table-list user-list">
            <table>
              <?php if (!empty($requests)): ?>
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <p style="text-align: center; font-weight:600; font-size:20px;">No completed requests found.</p>
              <?php endif; ?>
            </table>
            <br>
          </div>
