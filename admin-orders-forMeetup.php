      ...
      <div class="user-info-main">
        ...
        <div class="user-main-area">
          <div class="StatusTabs">
            ...
            <a href="admin-orders-forMeetup.php"><button class="button-alt active">For Meetup</button></a>
          ...
          <div class="table-list user-list">
            <table>
              <?php if (!empty($orders)): ?>
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <p style=" text-align: center; font-weight:600; font-size:20px;">No orders to be delivered.</p>
              <?php endif; ?>
            </table>
          </div>
        </div>
