...
$requests = fetchRequests('Pending');
      ...
      <div class="user-info-main requests">
        ...
        <div class="user-main-area">
          <div class="StatusTabs">
            <a href="admin-requests.php"><button class="button-alt active">Pending</button></a> <!--Requests placed-->
          ...
          <div class="table-list user-list">
            <table>
              <?php if (!empty($requests)): ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="button-area">
                        <a href="admin-requestAccept.php?request_id=<?= urlencode($request['RequestId']) ?>">
                          <button type="submit" class="table-button btn-update">
                            <i class="fa fa-check"></i> Accept
                          </button>
                        </a>
                        <a href="admin-requestReject.php?request_id=<?= urlencode($request['RequestId']) ?>">
                          <button type="submit" class="table-button btn-reject">
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <p style="text-align: center; font-weight:600; font-size:20px;">No pending requests found.</p>
              <?php endif; ?>
            </table>
            <br>
          </div>
