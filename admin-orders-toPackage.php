      ...
      <div class="user-info-main">
        ...
        <div class="user-main-area">
          <div class="StatusTabs">
            <a href="admin-orders.php"><button class="button-alt">Pending</button></a> <!--Orders placed-->
            <a href="admin-orders-toPackage.php"><button class="button-alt active">To Package</button></a>
          ...
          <div class="table-list user-list">
            <table>
              <?php if (!empty($orders)): ?>
                    ...
                    <td>
                      <div class="button-area">
                        <form action="actions/db_updateOrderStatus.php" method="POST">
                          ...
                          <button type="button" class="table-button btn-update confirmTrigger" data-message="Are you sure you want to update the status of this order?">
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <p style=" text-align: center; font-weight:600; font-size:20px;">No orders to be packaged.</p>
              <?php endif; ?>
            </table>
          </div>
        </div>
